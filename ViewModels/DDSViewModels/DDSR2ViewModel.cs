...
public class DDSR2ViewModel : DDSRegisterViewModel
{
    ...
    public bool CSR
    {
        get => _csr;
        set =>
            SetValue(ref _csr, value).Then(UpdateRegisterValue);
    }

    #endregion

    public string[] CpCurrentSetting { get; } =
    {
        "0.31", "0.63", "0.94", "1.25",
        "1.57", "1.88", "2.19", "2.5",
        "2.81", "3.13", "3.44", "3.75",
    ...
    private int _cpCurrentSettingSelectIndex;
    ...
    public string[] Prescaler { get; } = { "4/5", "8/9" };

    #region NotifyProperty <int> PrescalerSelectIndex

    private int _prescalerSelectIndex;
    ...
    public bool Rdiv2
    {
        get => _rDiv2;
        set =>
            SetValue(ref _rDiv2, value).Then(UpdateRegisterValue);
    }
    ...
    public bool ReferenceDoubler
    {
        ...
        set =>
            SetValue(ref _referenceDoubler, value).Then(UpdateRegisterValue);
    }
    ...
    {
        int rCounter = RCounter == 32 ? 0 : RCounter;
        int newValue =
    ...
    protected override void UpdateBitFields(uint registerValue)
    {
        ...
        int rCounter = Register.GetBitFiled(registerValue, 15, 5);
